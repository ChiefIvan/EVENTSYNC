...
* `event_sync` - project name - lowercase, no spaces, i.e. "snake_case" identifier - used as a package name, iOS/macOS/Android bundle name and Windows/Linux executable file name.
* `` - project description.
* `Event Sync` - project display name that is shown in window titles and about app dialogs.
